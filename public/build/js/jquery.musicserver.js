...
(function ($) {
    ...
    $.fn.MusicServer = function (options) {
        ...
        var settings = $.extend({
            shuffle_location: "build/js/jquery.shuffle.min.js", // Location for Shuffle script
            qtip_location: ["build/qtip/jquery.qtip.min.js", "musicserver/server/qtip/imagesloaded.pkg.min.js"], // Location for qTip script
            unveil_location: "build/js/jquery.unveil.js", // Location for Unveil script
            mainindex_location: "", // Location of main index document
            mainimage_folder: "build/images/",
            music_folder: "build/playlists"
        }, options);
        ...
        }); //add layout variable to dropdown menu (can be found in settings.js)

        $.each(playlists, function (idx, obj) {
            $('#playlist-select').append("<option>" + obj.playlist + "</option>");
        }); //add playlists variable to dropdown menu (can be found in settings.js)
